...
class PIA(object):
    ...
    def __init__(self, p_graph, robots, logger):
        ...
        ##!!!!!Caution here!!!!!!
        self.p_graph = p_graph[0]
        ##!!!!!Caution here!!!!!!

        self.robots = robots[1]
        ##print(robots)
    ...
    def allocate_tasks(self):
        ...
        while not rospy.is_shutdown():
            ...
            print(tf, tl, ts)
            for vertex in tf:
                print(vertex.task, vertex.priority)
            ...
            ##t_auct = set([ vertex.task for vertex in tf if vertex.priority > c ])  ##problem found: no priority assigned
            t_auct = set([vertex.task for vertex in tf])
            print(t_auct)
            '''for v in tf:
            ...
            while not self._auction_finished :
                ...
                print("_auction_pub", self._auction_pub, msg) ##msg  here id is 1, task[] and PC[] are all empty
                r.sleep()    
