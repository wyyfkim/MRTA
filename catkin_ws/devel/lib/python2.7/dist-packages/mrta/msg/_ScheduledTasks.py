...
class ScheduledTasks(genpy.Message):
  _md5sum = "0a0dfcdd660c4e0812362731470f2461"
...
int32 duration
int32[2] location"""
  __slots__ = ['robot_id','tasks','makespan','travel_time']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       robot_id,tasks,makespan,travel_time
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_if().pack(_x.makespan, _x.travel_time))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.makespan, _x.travel_time,) = _get_struct_if().unpack(str[start:end])
      return self
